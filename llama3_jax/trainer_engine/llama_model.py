...
class LoRADense(Module):
    ...
    def __call__(self, inputs: Any) -> Any:
        ...
        kernel_value = kernel_value.astype(jnp.bfloat16)
        lora_a_value = lora_a_value.astype(jnp.bfloat16)
        lora_b_value = lora_b_value.astype(jnp.bfloat16)
        if bias_value is not None:
            bias_value = bias_value.astype(jnp.bfloat16)
